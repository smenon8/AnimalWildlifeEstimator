...
# This method will convert all the categorial inputs to dummy variables.
...
# Convert every row in the data into discretized format depending on the type of the classification algorithm.
...
# Returns a classifier object depending on the method name passed
...
# splits the data recieved in the form of a python object into training and testing data.
# trainTestSplit is a number between 0 and 1 corresponsing to the ratio train:test.
